...
vim.keymap.set("n", "<C-t>t", ":lua require('telescope').extensions.git_worktree.git_worktrees()<cr>")
vim.keymap.set("n", "<C-t>n", ":lua require('telescope').extensions.git_worktree.create_git_worktree()<cr>")
